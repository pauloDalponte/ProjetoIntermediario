    ...
    public Weather converteInfo(String cep) {
        return webClient.get()
            .uri(uriBuilder -> uriBuilder
                ...
                .build())
            .retrieve()
            .onStatus(httpStatus -> httpStatus.is4xxClientError(), response -> Mono.error(new RuntimeException("Erro ao acessar a API do terceiro."))) //verifica status da resposta http
            ...
            .onErrorResume(e -> {
                return Mono.error(new RuntimeException("Falha ao acessar Api do Terceiro.")); //
            })
